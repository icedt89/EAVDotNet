namespace JanHafner.EAVDotNet.Instanciation.ChangeTracking
{
    ...
    /// <summary>
    /// Intercepts the property set of a, as Complex classified, property.
    /// </summary>
    internal sealed class ComplexPropertyChangeTrackingInterceptor : PropertyChangeTrackingInterceptor
    {
        [NotNull]
