namespace JanHafner.EAVDotNet.Instrumentation.InstanceSystem.PropertyValueFactories.Collection
{
    ...
    /// <summary>
    /// Creates instances of <see cref="ByteCollectionItem"/> instances.
    /// </summary>
    [Export(typeof(ICollectionItemFactory))]
    internal sealed class ByteCollectionItemFactory : ICollectionItemFactory
    {
        /// <summary>
        /// Checks if the <paramref name="itemType"/> is a <see cref="Byte[]"/>.
        /// </summary>
        ...
        public Boolean CanCreateCollectionItem(Type itemType)
        {
            ...
            return itemType == typeof(Byte) || itemType == typeof(Byte?);
        }
        ...
        public CollectionItem CreateCollectionItem(CollectionItemCreationContext collectionItemCreationContext)
        {
            ...
            var value = Byte.Parse(collectionItemCreationContext.ItemInstance.ToString());

            return new ByteCollectionItem(value);
        }
    }
}