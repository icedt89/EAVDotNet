namespace JanHafner.EAVDotNet.Instrumentation.InstanceSystem.PropertyValueFactories.Collection
{
    ...
    /// <summary>
    /// Creates instances of <see cref="DateTimeCollectionItem"/> instances.
    /// </summary>
    [Export(typeof(ICollectionItemFactory))]
    internal sealed class DateTimeCollectionItemFactory : ICollectionItemFactory
    {
        /// <summary>
        /// Checks if the <paramref name="itemType"/> is a <see cref="DateTime"/>.
        /// </summary>
        ...
        public Boolean CanCreateCollectionItem(Type itemType)
        {
            ...
            return itemType == typeof(DateTime) || itemType == typeof(DateTime?);
        }
        ...
        public CollectionItem CreateCollectionItem(CollectionItemCreationContext collectionItemCreationContext)
        {
            ...
            var value = DateTime.Parse(collectionItemCreationContext.ItemInstance.ToString());

            return new DateTimeCollectionItem(value);
        }
    }
}