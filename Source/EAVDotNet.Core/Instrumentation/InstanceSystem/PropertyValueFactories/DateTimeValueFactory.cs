namespace JanHafner.EAVDotNet.Instrumentation.InstanceSystem.PropertyValueFactories
{
    ...
    /// <summary>
    /// Creates instances of <see cref="DateTimePropertyValue"/> instances.
    /// </summary>
    [Export(typeof(IPropertyValueFactory))]
    internal sealed class DateTimeValueFactory : PropertyValueFactory
    {
        /// <summary>
        /// Checks if the supplied <see cref="Type"/> represents a <see cref="DateTime"/>.
        /// </summary>
        ...
        protected override PropertyValue CreatePropertyValueCore(PropertyValueCreationContext propertyValueCreationContext, Object propertyValue)
        {
            ...
            var value = DateTime.Parse(propertyValue.ToString());

            return new DateTimePropertyValue(value, propertyValueCreationContext.PropertyInfo);
        }
    }
}