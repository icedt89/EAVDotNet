namespace JanHafner.EAVDotNet.Instrumentation.InstanceSystem.PropertyValueFactories
{
    ...
    /// <summary>
    /// Creates instances of <see cref="Int64PropertyValue"/> instances.
    /// </summary>
    [Export(typeof(IPropertyValueFactory))]
    internal sealed class Int64PropertyValueFactory : PropertyValueFactory
    {
        /// <summary>
        /// Checks if the supplied <see cref="Type"/> represents a <see cref="Int64"/>.
        /// </summary>
        ...
        public override Boolean CanCreatePropertyValue(Type propertyType)
        {
            ...
            return propertyType == typeof(Int64) || propertyType == typeof(Int64?);
        }
        ...
        protected override PropertyValue CreatePropertyValueCore(PropertyValueCreationContext propertyValueCreationContext, Object propertyValue)
        {
            ...
            var value = Int64.Parse(propertyValue.ToString());

            return new Int64PropertyValue(value, propertyValueCreationContext.PropertyInfo);
        }
    }
}